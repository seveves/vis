 ...
 * @interface
 */
network.IOptions = function() {}
/**
 * @type {boolean}
 */
network.IOptions.prototype.autoResize;
/**
 * @type {string}
 */
network.IOptions.prototype.width;
/**
 * @type {string}
 */
network.IOptions.prototype.height;
/**
 * @type {string}
 */
network.IOptions.prototype.locale;
/**
 * @type {any} 
 */
network.IOptions.prototype.locales;
/** 
 * @type {boolean}
 */
network.IOptions.prototype.ckickToUse;

/**
 * @interface
 */
network.INetworkData = function() {}

/**
 * @type {any|any[]}
 */
network.INetworkData.prototype.nodes;

/**
 * @type {any|any[]}
 */
network.INetworkData.prototype.edges;

/**
 * @interface
 */
network.IPosition = function() {}
/**
 * @type {number}
 */
network.IPosition.prototype.x;
/**
 * @type {number}
 */
network.IPosition.prototype.y;

/**
 * @interface
 */
network.INetwork = function() {}
network.INetwork.prototype.destroy = function() {}

/**
 * @param {network.INetworkData} data
 */
network.INetwork.prototype.setData = function(data) {}
/**
 * @param {network.IOptions} options
 */
network.INetwork.prototype.setOptions = function(options) {}
/**
 * @param {network.IPosition} position
 * @return {network.IPosition}
 */
network.INetwork.prototype.canvasToDOM = function(position) {}
/**
 * @param {network.IPosition} position
 * @return {network.IPosition}
 */
network.INetwork.prototype.canvasToDOM = function(position) {}
network.INetwork.prototype.redraw = function() {}


/**
 * @return {boolean}
 */
network.INetwork.prototype.isActive = function() {}
/**
 * @param {string} width
 * @param {string} height
 */
network.INetwork.prototype.setSize = function(width, height) {}
